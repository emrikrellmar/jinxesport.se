...
const timelineEvents = [
  ...
  },
  {
    ...
    body: 'The first official roster signs on: ovztr, wezsen, kevzozo, zilly, and flaffys - establishing the competitive core of J!nX.',
  },
  {
    date: '15 July 2025',
    title: 'Bååten joins for ESEA S54',
    body: 'Linus "Bååten" Andersson commits to J!nX for ESEA League Season 54, adding tier-one experience and leadership in high-pressure matches. Forming the roster with emme1, Baaten, kevvzozo, wezsen and kreppo.',
  },
  {
    date: '31 August 2025',
  ...
  <div className="flex flex-col gap-20 pb-12">
    <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-carbon/80 px-8 py-12 shadow-[0_22px_60px_rgba(255,0,127,0.16)] md:flex md:items-stretch md:gap-12 md:px-14">
      ...
      <div className="flex-1 space-y-6">
        <p className="text-sm uppercase tracking-[0.45em] text-fuchsia/70">About J!nX Esport</p>
      ...
      <div className="mt-10 flex justify-center md:mt-0 md:w-[22rem] md:items-end">
        <div className="relative h-[20rem] w-[16rem] overflow-hidden rounded-[2.75rem] border border-white/10 bg-gradient-to-b from-fuchsia/20 to-transparent shadow-[0_25px_70px_rgba(255,0,127,0.22)] md:h-[26rem] md:w-[19rem]">
          <img
            src={braxenPhoto}
            alt="Braxen, founder of J!nX Esport"
    ...
    <section className="space-y-10">
      <div className="text-center">
        ...
        <p className="mt-4 text-base text-white/60">
          Follow the moments that shaped J!nX Esport from a local idea into a club chasing national competition and
          community impact.
        </p>
      </div>
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <div className="space-y-4">
          ...
          <p className="text-base text-white/70 md:text-lg">
            ...
            Sweden's premier CS2 league. Our ambition is to establish J!nX as a respected name in the Swedish esports
        ...
        <div className="space-y-4">
          ...
          <p className="text-base text-white/70 md:text-lg">
            At J!nX, we aim to create a safe and welcoming space where everyone can be themselves, develop at their own
