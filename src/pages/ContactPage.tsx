...
// FAQ embedded here (previously standalone) - keeps accessible accordion behavior
const faqs = [
  {
  ...
  <h1 className="mt-3 font-display text-4xl uppercase tracking-[0.3em] text-snow md:text-5xl">Connect with jinx esport</h1>
    ...
    <section id="faq" className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-white/70">Answers to common questions about membership, privacy and joining jinx esport.</p>
      </header>
